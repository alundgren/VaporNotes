...
public class JwtGenerator
{
    ...
    //TODO: Swap to our own keys instead of the example and move them out of code and into secrets storage

    // The public key to the corresponding private key of the authentication service
    // It is used to validate the JWT
    public const string PublicKey = @"MIICCgKCAgEAtCR2Pii+q9C76P2E9ydHYxnBPjJFGT7MvHuQPKpcS9RImfrkobt0
